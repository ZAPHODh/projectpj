...
export const defaultProfessionalValues: z.infer<typeof createProfessionalSchema> = {
    name: "",
    category: "hair",
    cpf: "",
    phone: "",
...
export function GetProfessionalConfig(datas: CommissionRule[], chave: string, locale: string, messages: Record<string, any>) {
